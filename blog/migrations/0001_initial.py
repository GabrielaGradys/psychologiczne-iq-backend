    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=30, unique=True)),
                ('description', models.TextField(blank=True, null=True)),
                ('posts_by_tag', models.ManyToManyField(related_name='tag', related_query_name='tag', to='blog.post')),
            ],
        ),
        migrations.AddField(
            model_name='post',
            name='tags',
            field=models.ManyToManyField(blank=True, related_name='post_by_tag', related_query_name='post_by_tag', to='blog.tag'),
        ),
    ]
